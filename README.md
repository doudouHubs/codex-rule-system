...
- `$rule-check`: open the Windows native rule checker to search, edit, and pick project-shared rules; CLI list/update/delete/pick remains available.
...
打开 rule-check 窗口，从项目规则库里手动搜索、编辑并拾取规则。
```
